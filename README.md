...
You can see a demonstration video, find more info about this project and how I made it here: https://www.youtube.com/watch?v=_QPlFLTgm8g
### It's pourpose
...
- It's pretty cool actually to be able to see what's happeing in a so popullar water bottle rocket.
...
- It has a "replay mode" which can literally replay the last flight from a `.csv` file.
